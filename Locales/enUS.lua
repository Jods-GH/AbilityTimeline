...
if L then
    ...
    L["ImportSuccess"] = "Successfully imported %d reminder(s)"
    L["ImportError"] = "Import failed: %s"
    L["ImportValidationError"] = "Invalid import data: %s"
    L["ImportPreview"] = "%d reminder found"
    L["ImportPreviewEmpty"] = "Paste import data to get started"
    L["ImportPreviewPlural"] = "%d reminders found"
